...
export const featureOptions: { [index: string]: AccessFeatureOption[] } = {
  ...
  "Hub": [
    ...
    { default: false, defaultValue: "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx", description: "Only trigger doorbell ring events for these door guard ids (comma separated).", hasCapability: [ "door_bell" ], name: "Doorbell.DoorGuardIds" },
